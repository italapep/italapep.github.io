/**
 * LAPEP-ITA — config.js
 * Editado via painel admin em 21/06/2026, 08:42:38
 */
...
CEP 12228-900' ,
  ...
  publicacoes: [
    { ano: 2026, titulo: 'Optimization of a green bipropellant with monoethanolamine, 2-propanol, and hydrogen peroxide 90 wt% as oxidizer' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Brazilian Journal of Chemical Engineering' , qualis: 'A3' , doi: '' , pdf: 'Portifolio/Publicados/2026_Optimization of a green bipropellant with monoethanolamine, 2-propanol, and hydrogen peroxide 90 wt% as oxidizer.pdf'  },
    { ano: 2026, titulo: 'Development and optimization of a green hypergolic gel propellant based on gelled ethanol with aluminum powder and copper(II) chloride with 90% hydrogen peroxide as oxidizer' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Acta Astronautica, v.247, p.669-680' , qualis: 'A2' , doi: '' , pdf: 'Portifolio/Publicados/2026_Development and optimization of a green hypergolic gel propellant based on.pdf'  },
    { ano: 2025, titulo: 'Composition optimization of a hypergolic green propellant based on monoethanolamine, n-butanol and 90% hydrogen peroxide' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Acta Astronautica, v.229, p.140-148' , qualis: 'A2' , doi: '' , pdf: 'Portifolio/Publicados/2025_Composition optimization of a hypergolic green propellant based on.pdf'  },
    { ano: 2022, titulo: 'Thermal, Viscosimetric and Thermomechanical Combined Assessment of Mixture Modelled Composite Fuels for Hybrid Propulsion' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Propellants, Explosives, Pyrotechnics, v.47' , qualis: 'A4' , doi: '' , pdf: 'Portifolio/Publicados/2022_Thermal, Viscosimetric and Thermomechanical Combined Assessment of Mixture Modelled Composite Fuels for Hybrid Propulsion.pdf'  },
    { ano: 2021, titulo: 'Assessing the Performance of a Green Liquid Fuel Hypergolic with Hydrogen Peroxide in a 50 N Bipropellant Thruster' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Int. Journal of Energetic Materials and Chemical Propulsion, v.20, p.21-30' , qualis: 'B3' , doi: '' , pdf: 'Portifolio/Publicados/2021_ASSESSING THE PERFORMANCE OF A 50 N BIPROPELLANT THRUSTER.pdf'  },
    { ano: 2021, titulo: 'Conversion of Co-Mn-Al hydrotalcites in highly active spinel-type catalysts for peroxide decomposition' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Catalysis Today, v.397-399, p.365-374' , qualis: 'A1' , doi: '' , pdf: 'Portifolio/Publicados/2022_Conversion of Co-Mn-Al hydrotalcites in highly active spinel-type catalysts for peroxide decomposition.pdf'  },
    { ano: 2021, titulo: 'Laboratory scale method for preparation of mixture modeled composite fuels for hybrid propulsion' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Journal of Energetic Materials, v.1, p.1-18' , qualis: 'A2' , doi: '' , pdf: 'Portifolio/Publicados/2021-Laboratory scale method for preparation of mixture modeled composite fuels for hybrid propulsion.pdf'  },
    { ano: 2020, titulo: 'CoMn-Spinel Oxides as Supported Catalyst for Rocket-Grade Hydrogen Peroxide Decomposition' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Propellants, Explosives, Pyrotechnics, v.45' , qualis: 'A4' , doi: '' , pdf: 'Portifolio/Publicados/2020_CoMn‑Spinel Oxides as Supported Catalyst for Rocket‑Grade Hydrogen Peroxide Decomposition.pdf'  },
    { ano: 2018, titulo: 'Development of a rocket liquid fuel based on monoethanolamine and ethanol hypergolic with hydrogen peroxide' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Int. Journal of Energetic Materials and Chemical Propulsion, v.17, p.137-145' , qualis: 'B3' , doi: '' , pdf: 'Portifolio/Publicados/2018_A DOE STUDY ON THE HYPERGOLICITY.pdf'  },
    { ano: 2016, titulo: 'Bulk catalyst for nitrous oxide decomposition in space thrusters' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Int. Journal of Energetic Materials and Chemical Propulsion, v.15, p.123-130' , qualis: 'B3' , doi: '' , pdf: 'Portifolio/Publicados/2016_BULK CATALYST FOR NITROUS OXIDE.pdf'  },
    { ano: 2014, titulo: 'CoMn-Based Oxides as Bulk Catalyst for Rocket-Grade Hydrogen Peroxide Decomposition' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Journal of Propulsion and Power (AIAA), v.30, p.309-313' , qualis: 'A3' , doi: '' , pdf: 'Portifolio/Publicados/2014_CoMn-Based Oxides as Bulk Catalyst for Rocket-Grade.pdf'  },
    { ano: 2014, titulo: 'Development and Optimization of a Catalytic Thruster for Hydrogen Peroxide Decomposition' , autores: 'Pereira, L.G.F. et al.' , periodico: 'Journal of Aerospace Technology and Management (JATM), v.6, p.61-67' , qualis: 'B1' , doi: '' , pdf: 'Portifolio/Publicados/2014_Development and Optimization of a catalytic thruster for hydrogen peroxide decmposition.pdf'  }
  ],
  ...
  equipe: [
    ...
    { nome: 'Ítalo Cesar' , papel: 'Mestrado' , foto: '' , tema: 'Síntese de Precursor de Alumina' , tipo: 'aluno'  },
    { nome: 'Lucas Mendes' , papel: 'Mestrado' , foto: '' , tema: 'Catalisadores para H₂ Verde' , tipo: 'aluno'  },
    { nome: 'Gabriel Rodrigues' , papel: 'Mestrado' , foto: '' , tema: 'Manufatura Aditiva — Monólitos de Alumina' , tipo: 'aluno'  },
    { nome: 'Rodrigo Tavares' , papel: 'Mestrado' , foto: '' , tema: 'Propulsor Monopropelente a HTP' , tipo: 'aluno'  },
    { nome: 'Matheus Oliveira' , papel: 'Mestrado' , foto: '' , tema: 'Combustível Hipergólico para Sistemas Bipropelentes' , tipo: 'aluno'  },
    { nome: 'Ana Clara Souza' , papel: 'Mestrado' , foto: '' , tema: 'Catalisadores para HTP e ADN' , tipo: 'aluno'  },
    { nome: 'Guilherme Araujo' , papel: 'IC' , foto: '' , tema: 'Espinélios para Decomposição de HTP' , tipo: 'aluno'  },
    { nome: 'Beatriz Cardoso' , papel: 'IC' , foto: '' , tema: 'Oxidantes Verdes ADN e HTP' , tipo: 'aluno'  },
    { nome: 'Pedro Henrique Lima' , papel: 'IC' , foto: '' , tema: 'Catalisadores de Ag por DOE' , tipo: 'aluno'  },
    { nome: 'Larissa Ferreira' , papel: 'IC' , foto: '' , tema: 'Óxidos Mistos para Fotocatálise' , tipo: 'aluno'  },
    { nome: 'Rafael Costa' , papel: 'IC' , foto: '' , tema: 'Materiais Carbonosos para Eletrocatálise' , tipo: 'aluno'  },
  ...
  noticias: [
    { titulo: 'Bem-vindo ao site do LAPEP!' , data: 'Junho 2025' , texto: 'Faça parte do LAPEP' , imagem: 'Faça parte do LAPEP.png' , ativo: true }
  ]
