/**
 * LAPEP-ITA — config.js
 * Editado via painel admin em 21/06/2026, 12:58:14
 */
...
const LAPEP_CONFIG = {
  ...
  projetos: [
    { titulo: 'Use of Hydrogen Peroxide as Propellant in Propulsion Systems' , descricao: 'P&D e desenvolvimento tecnológico com parceria internacional (TII). HTP como propelente para satélites e micropropulsores, com interesse estratégico para a defesa nacional. [T]' , status: 'Em andamento' , tipo: ''  },
  ...
  defesas: [
    { ano: 2025, tipo: 'Mestrado' , titulo: 'Desenvolvimento de Hexaaluminato de Lantânio para Emprego como Suporte Catalítico em Sistemas Propulsivos Monopropelentes' , nome: 'Geovanna Karolinne Carvalho Santos' , papel: 'Orientador [T]' , instituicao: 'ITA / CAPES'  },
  ...
  parcerias: [
    { sigla: 'INPE' , imagem: 'INPE.png' , nome: 'INPE / LCP' , descricao: 'Laboratório de Combustão e Propulsão — parceria histórica em propulsão e foguetes desde 2011. [T]'  },
  ...
  publicacoes: [
    { ano: 2026, titulo: 'Optimization of a green bipropellant with monoethanolamine, 2-propanol, and hydrogen peroxide 90 wt% as oxidizer' , autores: 'Cardoso, R.F. et al.' , periodico: 'Brazilian Journal of Chemical Engineering' , qualis: 'A3-T' , doi: '' , pdf: 'Portifolio/Publicados/2026_Optimization of a green bipropellant with monoethanolamine, 2propanol, and hydrogen peroxide 90 wt% as oxidizer.pdf'  },
  ...
  equipe: [
    { nome: 'Prof. Dr. Luís Gustavo Ferroni Pereira' , papel: 'Coordenador | Professor Adjunto' , foto: 'Fotos Alunos/Luis-Gustavo.jpeg' , tema: 'Monopropelentes, bipropelentes hipergólicos, propelentes sólidos e híbridos, propelentes em gel, catalisadores, suportes catalíticos, manufatura aditiva, H₂ verde, fotocatálise, materiais carbonosos e materiais eletromagnéticos [T]' , tipo: 'professor'  },
